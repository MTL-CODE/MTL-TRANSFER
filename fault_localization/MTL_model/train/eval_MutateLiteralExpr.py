...
class Evaluate(object):
    def __init__(self, trian_model):
        ...
        self.batcher = Batcher(config_MutateLiteralExpr.eval_data_path, self.vocab, mode='eval',
                               batch_size=config_MutateLiteralExpr.batch_size, single_pass=False)
        time.sleep(15)
        # model_name = os.path.basename(model_file_path)

        eval_dir = os.path.join(config_MutateLiteralExpr.log_root, 'eval_%s' % (trian_model))
    ...
    def run_eval(self):
        ...
        iter = 0
        n_iters = config_MutateLiteralExpr.eval_niters 
