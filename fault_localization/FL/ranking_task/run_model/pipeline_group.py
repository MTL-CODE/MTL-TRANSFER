...
with open("../ranking_task/run_model/x.pkl", "rb") as file:
	x_data = pickle.load(file)
with open("../ranking_task/run_model/y.pkl", "rb") as file:
...
for group_index in range(10):
	...
	data_path = "../ranking_task/run_model/data/{}/".format(group_index + 1)
