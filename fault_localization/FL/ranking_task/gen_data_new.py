...
semantic_path = os.path.join(data_path, "semantic_new.pkl")
with open(semantic_path, "rb") as file:
	semantic = pickle.load(file)

with open("./ranking_task/faulty_statement_index.pkl", "rb") as file:   
...
# save data and label
with open("./ranking_task/run_model/x.pkl", "wb") as file:
	pickle.dump(data, file)
with open("./ranking_task/run_model/y.pkl", "wb") as file:
