...
pattern_list = ['InsertMissedStmt', 'InsertNullPointerChecker', 'MoveStmt','MutateConditionalExpr','MutateDataType','MutateLiteralExpr','MutateMethodInvExpr','MutateOperators','MutateReturnStmt','MutateVariable','RemoveBuggyStmt']
...
for type_1 in pattern_list:
	...
	print("pretrain_vectors：",pretrain_vectors[1])
	...
	for epoch in range(EPOCHS):
		...
		print("[Epoch: %3d/%3d]\n"
			  ...
			  "Time Cost: %.3f s"
			  % (epoch + 1, EPOCHS,
				 train_loss_[epoch], val_loss_[epoch],
